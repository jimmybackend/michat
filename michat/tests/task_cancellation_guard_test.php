...
$ok(substr_count($bedrock,'$this->checkpoint($request)')>=3&&strpos($bedrock,'$this->checkpoint($request)')<strpos($bedrock,'$bedrock->converse')&&strpos($bedrock,'$this->checkpoint($request)',strpos($bedrock,'$bedrock->converse'))<strpos($bedrock,"\$usage['prompt_tokens']"),'checkpoint precede Bedrock y vuelve a validar al terminar la llamada');
