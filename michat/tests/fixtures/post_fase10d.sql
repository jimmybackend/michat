-- Supported-upgrade fixture: exact adbbmis1_Cloud.sql snapshot from commit
-- e1a96e703af8748b59c4603137b4374c3990e54c (Fase 10 closure),
-- with only CREATE DATABASE/USE removed so the test-selected temporary DB remains authoritative.
-- phpMyAdmin SQL Dump
-- version 5.2.3
