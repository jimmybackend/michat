...
$checks=[
 ...
 str_contains($js,'¿Qué produjo esta Task?')&&str_contains($js,'a.step_title')&&!str_contains($js,'details_json'),
 str_contains($css,'.timeline-event')&&str_contains($css,'.execution-history')&&str_contains($css,'.artifact-list'),
