...
$image=(string)file_get_contents($root.'/michat/chat_gen_image.php');$imageGuard=strpos($image,'resolveOwnedSession(');$imageBedrock=strpos($image,'Config::getBedrockRuntime()');$imageInsert=strpos($image,'INSERT INTO ChatMessages');$ok($imageGuard!==false&&$imageBedrock!==false&&$imageInsert!==false&&$imageGuard<$imageBedrock&&$imageGuard<$imageInsert,'image owner guard precedes Bedrock and DB write');
