...
$approval=$service->execute(['step_type'=>'approval'],$beat,$notCancelled);$wait=$service->execute(['step_type'=>'wait'],$beat,$notCancelled);$ok($approval->status==='waiting_user'&&$wait->status==='waiting_user','approval/wait pausan sin dormir');
