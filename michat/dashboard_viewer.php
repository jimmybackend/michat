...
<style>
    ...
    * {
    ...
    html {
        ...
        overflow-y: scroll !important; /* Fuerza la barra de scroll siempre visible */
        overflow-x: hidden;
    ...
    /* ===== FORZAR QUE EL CONTENIDO SEA VISIBLE Y HAGA SCROLL ===== */
    #dashboard-content {
        display: block;
        width: 100%;
        min-height: 200px;
    ...
    * {
    ...
    /* ===== FIX: Asegurar que el gráfico no rompa el layout ===== */
    #chartTokenUsage {
        max-height: 280px;
        max-width: 100%;
    }

    /* ===== FIX: Forzar que el body pueda hacer scroll ===== */
    #dashboard-content > * {
        display: block;
    }

    /* Debug: borde rojo para ver si el contenedor se expande */
    /* #dashboard-content { border: 1px solid red; } */
</style>
</head>
...
function renderDashboard(data) {
    ...
    let html = `
        ...
        <!-- Desglose por fase - GRÁFICO -->
        <div class="section-title">
            <i class="fas fa-chart-pie"></i>
            Distribución de Tokens por Fase del Pipeline
        </div>
        ...
        <!-- Footer invisible para forzar más altura -->
    ...
    // Forzar que el body tenga altura después de renderizar
