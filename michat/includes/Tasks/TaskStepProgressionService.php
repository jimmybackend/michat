...
final class TaskStepProgressionService implements TaskStepProgressionInterface
{
 ...
 public function apply(array$c,TaskStepExecutionResult$r):bool{return$this->queue->finish($c,str_starts_with($r->status,'waiting_')?$r->status:'completed',$r->messageId,$r->summary,null,$r->checkpoint,null,$r->modelId);}
