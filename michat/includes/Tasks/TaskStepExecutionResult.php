...
{
    public function __construct(public readonly string $status, public readonly string $summary = '', public readonly array $artifacts = [], public readonly ?array $checkpoint = null, public readonly ?int $messageId = null, private readonly bool $durablePauseAlreadyPersisted = false, public readonly ?string $modelId = null)
    {
        if($durablePauseAlreadyPersisted&&$status!=='waiting_user')throw new InvalidArgumentException('persisted_pause_status_invalid');
    }
    public static function completed(string $summary, array $artifacts = [], ?array $checkpoint = null, ?int $messageId = null, ?string $modelId = null): self { return new self('completed', mb_substr($summary, 0, 1000), $artifacts, $checkpoint, $messageId, false, $modelId); }
