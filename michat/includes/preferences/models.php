<div class="settings-pane-intro settings-pane-intro-models">
    <div class="settings-pane-icon"><i class="fas fa-robot"></i></div>
    <div>
        <h6 class="mb-1">Modelos IA</h6>
        <p class="mb-0 small text-muted">Selecciona qué modelos ejecutan cada trabajo y ajusta sus parámetros técnicos.</p>
    </div>
</div>
...
<section class="settings-card settings-card-primary">
    <div class="settings-card-heading">
        <div>
            ...
            <h6>Modelo principal del chat</h6>
        </div>
        <span class="settings-card-badge"><i class="fas fa-comment-dots"></i> chat_main</span>
    </div>
    <p class="small text-muted mb-3">Modelo que genera la respuesta final. Los modelos incompatibles siguen bloqueados por la lógica actual.</p>
